      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        >
          {content.problems.cards.map((card, i) => (
            ...
            >
              {/* Icon */}
              <div className="w-10 h-10 rounded-xl bg-secondary/8 flex items-center justify-center mb-4 group-hover:bg-secondary/12 transition-colors duration-200">
              ...
              <h3 className="font-archivo font-bold text-lg tracking-tight text-primary mb-2 text-balance leading-snug">
                {card.title}
              </h3>
