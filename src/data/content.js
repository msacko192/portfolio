...
export const content = {
  ...
  hero: {
    ...
    // Champs legacy — conservés pour référence, non utilisés par Hero.jsx
    label: 'Studio · Applications métier sur mesure',
    ...
    body: "Nous développons des applications métier sur mesure adaptées à votre façon de travailler. Nous aidons les PME à remplacer leurs fichiers Excel, leurs tâches manuelles et leurs outils dispersés par des solutions simples, rapides et efficaces.",
  },
